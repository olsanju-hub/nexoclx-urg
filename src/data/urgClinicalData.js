...
const sourceRegistry = [
  ...
  {
    id: 'kdigo-renal',
    label: 'KDIGO Guidelines. Acute Kidney Injury/Acute Kidney Disease and CKD Evaluation and Management.',
    url: 'https://kdigo.org/guidelines/',
    supports: 'LRA/ERC, revision de nefrotoxicos, ajuste de medicacion, continuidad AKI-AKD-CKD y criterios de escalada renal.',
  },
  {
    id: 'gina-2026',
...
const protocolEnhancements = {
  ...
  sepsis: {
    ...
    medicationPlan: ['Antibiotico IV precoz tras cultivos si no retrasa; en shock o alta sospecha no demorar. Elegir segun foco, alergias, riesgo BLEE/MRSA/Pseudomonas y protocolo local.', 'Cristaloide balanceado 500 mL IV en 10-15 min y reevaluar perfusion. Si sepsis con hipoperfusion/shock y tolera volumen: objetivo inicial hasta 30 mL/kg en las primeras 3 h.', 'Si IC/ERC/anciano o congestion: bolos de 250 mL con ecografia pulmon/cava, relleno capilar, PAM, lactato y trabajo respiratorio.', 'Noradrenalina para PAM objetivo >=65 si shock persistente, hipotension profunda o fluidos no tolerados; no esperar a completar volumen si hay sobrecarga.', 'Control de foco: drenaje, cirugia, retirada/recambio de dispositivo o imagen urgente si foco no claro.'],
    specialSituations: ['Insuficiencia cardiaca/congestion: evitar 30 mL/kg automaticos; bolos pequeños, eco/pulmon y vasopresor precoz si no responde.', 'Insuficiencia renal: administrar dosis de carga antibiotica si shock; ajustar mantenimiento tras eGFR y monitorizar K/acidosis/diuresis.', 'Anciano fragil: fiebre ausente y delirium/caida pueden ser sepsis; usar objetivo de perfusion y techo terapeutico explicitado.', 'Inmunodeprimido/neutropenico: antibiotico antipseudomonico urgente y aislamiento/foco; no esperar reactantes.'],
  ...
  'dolor-toracico': {
    ...
    medicationPlan: ['AAS 150-300 mg VO masticado si SCA probable y no alergia/sangrado activo.', 'Nitroglicerina 0,4 mg SL cada 5 min hasta 3 dosis si dolor/HTA y PAS adecuada; pasar a IV si dolor/HTA persistente y monitorizacion. Evitar si hipotension, infarto VD o iPDE5 reciente.', 'Analgesia: fentanilo 25-50 mcg IV o morfina 2-4 mg IV titulada si dolor refractario, vigilando hipotension, nauseas y depresion respiratoria.', 'Anticoagulacion/P2Y12 segun estrategia SCA y protocolo de hemodinamica; comprobar sangrado activo, peso, eGFR, anticoagulante previo y necesidad de cirugia/TC.', 'Si TEP probable y no contraindica: anticoagular tras valorar riesgo hemorrágico; si shock, UCI/reperfusion.'],
    specialSituations: ['Sospecha diseccion: no antiagregar/anticoagular empiricamente; analgesia, control FC/TA y angioTC/cirugia.', 'Dolor + sincope/hipotension: pensar SCA alto riesgo, aorta, TEP o arritmia; no enviar a sala sin monitor.', 'Insuficiencia renal: ajustar anticoagulacion y no interpretar troponina aislada sin dinamica/ECG/clinica.', 'Anticoagulado: registrar farmaco, ultima dosis, eGFR e indicacion antes de doble/triple terapia.', 'Fallo cardiaco/EAP: nitratos/VMNI si PAS permite; evitar bolos de fluidos salvo infarto VD/shock seleccionado.'],
  ...
  sca: {
    ...
    medicationPlan: ['AAS 150-300 mg VO masticado, despues mantenimiento 75-100 mg/dia si ingreso y no contraindica.', 'Nitroglicerina 0,4 mg SL cada 5 min hasta 3 dosis o IV titulada si dolor/HTA sin contraindicaciones.', 'Analgesia titulada si dolor pese a nitratos: fentanilo 25-50 mcg IV o morfina 2-4 mg IV, reevaluando TA y respiracion.', 'Anticoagulacion y P2Y12 segun protocolo de SCA/hemodinamica. Si se indica heparina no fraccionada: requiere peso, estrategia invasiva y control de sangrado; si enoxaparina/fondaparinux, ajustar a eGFR.', 'Oxigeno solo si hipoxemia, distrés o shock; no rutinario si SpO2 normal.'],
    specialSituations: ['Infarto VD/hipotension: evitar nitratos; valorar bolos pequeños de cristaloide 250 mL si no congestion y priorizar reperfusion.', 'Anticoagulado: documentar farmaco/ultima toma/eGFR antes de añadir antitromboticos; alto riesgo de sangrado si triple terapia.', 'Sospecha aorta: detener antiagregacion/anticoagulacion hasta descartar.', 'ERC: evitar nefrotoxicos, ajustar antitromboticos y preparar estrategia de contraste con cardiologia.'],
  ...
  disnea: {
    ...
    medicationPlan: ['Oxigeno titulado: objetivo 94-98%; 88-92% si EPOC/retencion CO2 probable. Mascarilla reservorio si hipoxemia grave; alto flujo/VMNI/intubacion segun trabajo respiratorio.', 'EAP hipertensivo: VMNI/CPAP precoz, nitroglicerina si PAS permite, furosemida 20-40 mg IV si congestion y no hipotension.', 'Broncoespasmo: salbutamol 5 mg nebulizado repetible + ipratropio 0,5 mg nebulizado; prednisona 40-50 mg VO o metilprednisolona 40-80 mg IV; sulfato Mg 2 g IV en 20 min si asma grave.', 'Neumonia: antibiotico segun gravedad, foco y protocolo local; CURB-65/PSI no sustituyen juicio si hipoxemia o sepsis.', 'TEP alto riesgo: anticoagulacion si no contraindica; reperfusion/UCI si shock. Neumotorax a tension: descompresion inmediata.'],
    specialSituations: ['EAP hipotenso: evitar nitratos/diuresis agresiva; UCI, eco y vasopresor/inotropo segun perfil.', 'EPOC hipercapnico con acidosis: VMNI si protege via aerea; gasometria de control en 30-60 min.', 'Disnea + dolor pleuritico/sincope: Wells/PERC/PESI y TEP alto riesgo.', 'Insuficiencia renal: cuidado con diureticos/fluidos; gasometria e iones cambian conducta.', 'Anciano: disnea puede ser SCA/sepsis sin fiebre ni dolor tipico.'],
  ...
  arritmias: {
    ...
    medicationPlan: ['Cardioversion sincronizada inmediata si inestable; sedacion si el tiempo lo permite, pero no retrasar si shock franco.', 'FA estable: control frecuencia con metoprolol 2,5-5 mg IV lento repetible o diltiazem/verapamilo si FEVI conservada, sin hipotension ni IC descompensada.', 'Si IC descompensada, hipotension relativa o FEVI reducida: evitar calcioantagonistas; valorar digoxina o amiodarona segun contexto/protocolo.', 'WPW o QRS ancho irregular: evitar verapamilo, diltiazem, digoxina y betabloqueo; cardioversion si inestable.', 'Corregir K y Mg; sulfato Mg 2 g IV si torsades o hipomagnesemia relevante. Adenosina solo en taquicardia regular compatible, con monitor y preparada cardioversion.'],
    specialSituations: ['FA + hipotension: decidir si la arritmia causa inestabilidad; si si, cardioversion. Si shock por sepsis/hipovolemia, tratar causa y evitar frenado excesivo.', 'FA + EAP/congestion: cardioversion si inestable; evitar calcioantagonistas si IC sistolica/descompensada; no dar fluidos salvo hipovolemia clara.', 'Anticoagulacion: CHA2DS2-VASc/HAS-BLED para plan, pero no retrasar cardioversion inestable; si estable >48 h o inicio incierto, coordinar estrategia.', 'Bradicardia sintomatica: atropina 0,5 mg IV repetible hasta 3 mg, marcapasos/vasopresor si fracaso.'],
  ...
  'renal-urologia': {
    quickEntry: ['Creatinina elevada, oliguria/anuria, ERC conocida, colico, hematuria, retencion urinaria o sospecha obstructiva/infecciosa.'],
    firstDecision: ['Primero distinguir LRA vs ERC/agudizacion: comparar creatinina previa, diuresis, tiempo de evolucion, volumen y farmacos.', 'Grave: K alterado, acidosis, edema pulmonar, uremia sintomatica, anuria, sepsis u obstruccion bilateral/monorreno -> criticos/nefrologia/urologia.'],
    testPlan: ['Qué solicitar: creatinina/eGFR previa y actual, urea, Na/K/Cl/HCO3, Ca/P/Mg, gasometria si grave, hemograma, PCR si infeccion, orina/sedimento, albuminuria/proteinuria si procede, ECG si K alto.', 'No olvidar: diuresis real, sondaje si retencion, ecografia renal/vesical si obstruccion, CK si rabdomiolisis, revision de IECA/ARA-II/ARM, AINE, diureticos, metformina, contrastes y antibioticos nefrotoxicos.', 'Cambia conducta: K >=6 o ECG, pH bajo/HCO3 bajo, anuria, hidronefrosis, sepsis urinaria, sobrecarga pulmonar, creatinina que sube rapido.'],
    medicationPlan: ['Hipovolemia sin congestion: cristaloide balanceado 250-500 mL IV y reevaluar TA, pulmon, diuresis y creatinina.', 'Congestion/EAP: no fluidos; oxigeno/VMNI si precisa, diuretico si perfusion lo permite y valorar UCI/nefrologia.', 'Suspender/evitar nefrotoxicos y ajustar dosis renales de antibioticos, anticoagulantes, digoxina, opioides y sedantes.', 'HiperK: aplicar protocolo de electrolitos; calcio si ECG/inestabilidad, insulina-glucosa y eliminacion/dialisis segun caso.', 'Obstruccion: sondaje vesical si retencion; urologia urgente si sepsis obstructiva, anuria, monorreno, dolor no controlado o hidronefrosis significativa.'],
    specialSituations: ['Sepsis + LRA: dosis de carga antibiotica sin retraso; ajustar mantenimiento y fluidos segun respuesta/congestion.', 'ERC avanzada: creatinina aislada no define urgencia; mandan K, acidosis, volumen, sintomas uremicos y diuresis.', 'Metformina/contraste: valorar acidosis lactica/riesgo y suspender si LRA o hipoperfusion.', 'Anticoagulado con deterioro renal: alto riesgo acumulacion DOAC; documentar ultima dosis/eGFR antes de procedimientos.'],
    reevaluation: ['Diuresis horaria si grave, TA, peso/edemas, auscultacion/eco pulmon, K/gasometria seriados, creatinina y respuesta al sondaje/fluidos/diuretico.'],
    destination: { low: ['Alta solo si ERC conocida estable o LRA leve reversible, K/acido-base normales, diuresis conservada y control cercano.'], moderate: ['Observacion/ingreso si LRA moderada, causa no resuelta, infeccion, colico complicado, necesidad de fluidos/diuretico IV o ajuste complejo.'], high: ['UCI/nefrologia/urologia si anuria, hiperK, acidosis grave, EAP, sepsis, obstruccion infectada, dialisis probable o deterioro rapido.'] },
    sources: ['murillo-2023', 'kdigo-renal'],
  },
  ictus: {
