...
export const calculateVascularHeparinDose = ({ weightKg }) => {
  ...
  return doseResult({
    ...
    fields: {
      ...
      'Vía': 'IV',
      'Repetición/frecuencia': 'Perfusión continua; ajustar después solo con TTPa/anti-Xa y protocolo local.',
      'Evitar si': 'Sangrado activo, HIT, plaquetopenia relevante, cirugía reciente de alto riesgo o contraindicación hemorrágica/especializada.',
